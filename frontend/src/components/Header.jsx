...
const Header = () => {
  return (
    <div className="bg-primary rounded-xl flex flex-col md:flex-row flex-wrap px-6 md:px-10 lg:px-20">
      {/* Left Side */}
      <div className="md:w-1/2 flex items-start flex-col justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px] ">
